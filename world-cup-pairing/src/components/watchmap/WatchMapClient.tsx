              ...
              <button className="w-full text-left px-4 py-3"
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-400 mt-0.5">{formatMatchTime(m.matchDatetime)}</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                ...
                {expandedMatch !== m.matchId && m.venueBreakdown[0] && (
                  <div className="mt-2 flex items-center gap-1.5 text-xs text-gray-500">
                    ...
                    <span>Top spot: <span className="font-medium text-gray-700">{m.venueBreakdown[0].name}</span> ({m.venueBreakdown[0].count} going)</span>
                  </div>
                )}
              </button>
